...
**Следующий шаг:** D2 — обработать оставшиеся страницы с mojibake и `charset=windows-1251` (`F47C1.html`…`F47E4.html`, `ask46c6.html`, `blondy_strategy.html`, `spiralnaya_dinamika_vvedenie.html`): перекодировать, синхронизировать `meta charset` и зафиксировать проверки.
