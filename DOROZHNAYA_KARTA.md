...
- 🚧 M2: Перепроектировать пагинацию блога, чтобы избавиться от `%26page%3dN` в ссылках и при этом не ломать переходы на Cloudflare Pages; вариант с `/blog?page=N` отклонён — `_redirects` не обрабатывает query string.

**Следующий шаг:** M2 — найти рабочий формат ссылок пагинации блога, совместимый со статическими снапшотами Cloudflare Pages.
...
#### Шаг M2 — Корректировка пагинации блога
