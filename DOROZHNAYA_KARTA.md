...
**Следующий шаг:** D2 — подготовить и перекодировать партию тематических лендингов (`alphabet.html`, `alfavit.html`, `konstantin_pukhov.html`, `mind-layers.html`, `superpower.html`, `tss.html`, `tropa_sily.html`, `training10k*.html`, `video.html`, `trainers.html`, `skazki2012.html`), обновить мета-теги и выполнить проверки.
