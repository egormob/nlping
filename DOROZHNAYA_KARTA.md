...
- **Блок 12 (✅ выполнено):** `F05E6200-F45A7-0A75F0C1.html`, `F0651E00-F428A-D059ED75.html`, `F0CB3C38-F449A-60E70531.html`, `F2F5B577-F45F4-635C9E21.html` — партия на 4 файла, логи `logs/reencode-20251007T122318Z.json`, `logs/check_utf8-20251007T122332Z.json`; следующая цель — одиночные `F5*`, `F8*`, `F9*`, `FC*`.
