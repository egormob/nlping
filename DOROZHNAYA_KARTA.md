...
- ⬜ M1: Удалить текстовый вывод ретаргетинговых скриптов из футера и подтвердить чистый рендер (`rg 'perfectaudience'`, проверки `check_links`/`check_utf8`, ручной просмотр).
...
**Следующий шаг:** M1 — очистка футера от текстового вывода ретаргетинговых скриптов.
